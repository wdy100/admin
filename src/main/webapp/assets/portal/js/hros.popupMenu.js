		...
		*/
		app : function(obj){
			...
			$('.app-menu a[menu="moveto"]').off('click').on('click', function(){
				...
				$.ajax({
					type : 'POST',
					url : HROS.CONFIG.basicActionUrl+'/moveMyApp.action',
					data : 'id=' + obj.attr('appid') + '&todesk=' + desk,
					success : function(){
			...
			$('.app-menu a[menu="edit"]').off('click').on('click', function(){
				$.dialog.open(HROS.CONFIG.basicActionUrl+'/papp.action?valIsapp=1&id=' + obj.attr('appid'), {
					id : 'editdialog',
		...
		papp : function(obj){
			...
			$('.papp-menu a[menu="edit"]').off('click').on('click', function(){
				$.dialog.open(HROS.CONFIG.basicActionUrl+'/papp.action?id=' + obj.attr('appid'), {
					id : 'editdialog',
			...
			$('.folder-menu a[menu="rename"]').off('click').on('click', function(){
				$.dialog({
					...
					content : editFolderDialogTemp({
						...
						'imgPath' : HROS.CONFIG.basicStaticUrl
					}),
					ok : function(){
						if($('#folderName').val() != ''){
							$.ajax({
								type : 'POST',
								url : HROS.CONFIG.basicActionUrl+'/updateFolder.action',
								data : 'name=' + $('#folderName').val() + '&icon=' + $('.folderSelector img').attr('src_val') + '&id=' + obj.attr('appid'),
								success : function(){
									HROS.app.get();
								}
							});
...
//				TEMP.popupMenuDesk = $('<div class="popup-menu desk-menu" style="z-index:9990;display:none"><ul><li><a menu="hideall" href="javascript:;">显示桌面</a></li><li style="border-bottom:1px solid #F0F0F0"><a menu="closeall" href="javascript:;">关闭所有应用</a></li><li class="hideInHome"><a href="javascript:;" >新建<b class="arrow">»</b></a><div class="popup-menu" style="display:none"><ul><li><b class="folder"></b><a menu="addfolder" href="javascript:;">新建文件夹</a></li><li><b class="customapp"></b><a menu="addpapp" href="javascript:;">新建私人应用</a></li></ul></div></li><!--li style="border-bottom:1px solid #F0F0F0"><b class="upload"></b><a menu="uploadfile" href="javascript:;">上传文件</a></li--><li><b class="themes"></b><a menu="themes" href="javascript:;">主题设置</a></li><li><b class="setting"></b><a menu="setting" href="javascript:;">桌面设置</a></li><li style="border-bottom:1px solid #F0F0F0" class="hideInHome"><a href="javascript:;">图标设置<b class="arrow">»</b></a><div class="popup-menu" style="display:none"><ul><li><b class="hook"></b><a menu="orderby" orderby="x" href="javascript:;">横向排列</a></li><li><b class="hook"></b><a menu="orderby" orderby="y" href="javascript:;">纵向排列</a></li></ul></div></li><li><a menu="logout" href="javascript:;">注销</a></li></ul></div>');
				TEMP.popupMenuDesk = $('<div class="popup-menu desk-menu" style="z-index:9990;display:none"><ul><li><a menu="hideall" href="javascript:;">显示桌面</a></li><li style="border-bottom:1px solid #F0F0F0"><a menu="closeall" href="javascript:;">关闭所有应用</a></li><li class="hideInHome"><a menu="addfolder" href="javascript:;">新建文件夹</a></li><!--li style="border-bottom:1px solid #F0F0F0"><b class="upload"></b><a menu="uploadfile" href="javascript:;">上传文件</a></li--><li><b class="themes"></b><a menu="themes" href="javascript:;">主题设置</a></li><li><b class="setting"></b><a menu="setting" href="javascript:;">桌面设置</a></li><li style="border-bottom:1px solid #F0F0F0" class="hideInHome"><a href="javascript:;">图标设置<b class="arrow">»</b></a><div class="popup-menu" style="display:none"><ul><li><b class="hook"></b><a menu="orderby" orderby="x" href="javascript:;">横向排列</a></li><li><b class="hook"></b><a menu="orderby" orderby="y" href="javascript:;">纵向排列</a></li></ul></div></li><li><a menu="logout" href="javascript:;">注销</a></li></ul></div>');
				...
				$('.desk-menu a[menu="addfolder"]').on('click', function(){
					...
					$.dialog({
						...
						content : editFolderDialogTemp({
							'name' : '新建文件夹',
							'src' : HROS.CONFIG.basicStaticUrl+'/portal/img/ui/folder_default.png',
							'src_val':'portal/img/ui/folder_default.png',
							'imgPath' : HROS.CONFIG.basicStaticUrl
						}),
						ok : function(){
							if($('#folderName').val() != ''){
								$.ajax({
									type : 'POST',
									url : HROS.CONFIG.basicActionUrl+'/addFolder.action',
									data : 'name=' + $('#folderName').val() + '&icon=' + $('.folderSelector img').attr('src_val') + '&desk=' + HROS.CONFIG.desk,
									success : function(){
										HROS.app.get();
									}
								});
				...
				$('.desk-menu a[menu="addpapp"]').on('click', function(){
					...
					$.dialog.open(HROS.CONFIG.basicActionUrl+'/papp.action?desk=' + HROS.CONFIG.desk, {
						id : 'editdialog',
						title : '新建私人应用',
						width : 600,
						height : 450
				...
				$('.desk-menu a[menu="themes"]').on('click', function(){
					HROS.window.createTemp({
						appid : 'hoorayos-ztsz',
						title : '主题设置',
						url : HROS.CONFIG.basicActionUrl+'/wallpaper.action',
						width : 580,
						height : 520,
						isflash : false
					});
