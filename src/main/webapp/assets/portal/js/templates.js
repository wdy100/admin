...
var editFolderDialogTemp = template(
	'<div id="addfolder">'+
		...
		'<div class="fcDropdown">'+
				'<a class="fcDropdown_item" title="默认"><img class="fcDropdown_img"	src_val="portal/img/ui/folder_default.png" src="<%=imgPath%>/portal/img/ui/folder_default.png"></a>'+
				'<a class="fcDropdown_item" title="文本"><img class="fcDropdown_img"	src_val="portal/img/ui/folder_doc.png" src="<%=imgPath%>/portal/img/ui/folder_doc.png"></a>'+
				'<a class="fcDropdown_item" title="游戏"><img class="fcDropdown_img"	src_val="portal/img/ui/folder_game.png" src="<%=imgPath%>/portal/img/ui/folder_game.png"></a>'+
				'<a class="fcDropdown_item" title="生活"><img class="fcDropdown_img"	src_val="portal/img/ui/folder_life.png" src="<%=imgPath%>/portal/img/ui/folder_life.png"></a>'+
				'<a class="fcDropdown_item" title="音乐"><img class="fcDropdown_img"	src_val="portal/img/ui/folder_music.png" src="<%=imgPath%>/portal/img/ui/folder_music.png"></a>'+
				'<a class="fcDropdown_item" title="工具"><img class="fcDropdown_img"	src_val="portal/img/ui/folder_tool.png" src="<%=imgPath%>/portal/img/ui/folder_tool.png"></a>'+
				'<a class="fcDropdown_item" title="视频"><img class="fcDropdown_img"	src_val="portal/img/ui/folder_video.png" src="<%=imgPath%>/portal/img/ui/folder_video.png"></a>'+
		'</div>'+
	'</div>'
);
//应用评分
...
var helpTemp = template(
	'<div id="help">'+
		...
		'<div id="step1" class="step" step="1" style="position:relative;left:50%;top:50%;margin-left:-160px;margin-top:-60px;width:300px;height:110px">'+
			'<p style="text-align:center">'+
				'<span class="h2">欢迎使用crm OS</span>'+
		...
		'<div id="step2" class="step" step="2" style="top:90px;left:140px;width:250px">'+
			...
			'</p>'+
		'</div>'+
		'<div id="step3" class="step" step="3" style="bottom:90px;left:550px;width:200px">'+
			'<b class="jt jt_bottom" style="top:141px;left:20px"></b>'+
			'<p>'+
			...
			'</p>'+
		'</div>'+
		'<div id="step4" class="step" step="4" style="top:130px;left:30px;width:250px">'+
			...
			'</p>'+
		'</div>'+
		'<div id="step5" class="step" step="5" style="bottom:35px;left:30px;width:200px">'+
...
var deskNavTemp = template(
	'<% for(var i = 0; i < list.length; i++){ %>'+
		'<div id="b-content-0<%=i+1%>" class="deskNav">'+
		   '<a href="#" index="<%=i+1%>"><img src="<%=staticURL%>/portal/img/images/ico_folder.png" /></a>'+
//		   '<a href="#" index="<%=i+1%>"><img src="<%=staticURL%>/portal/img/images/icon-desktop.png" /></a>'+
...
var deskDockItemTemp = template(
		'<div class="one-widget" title="<%=title%>" type="<%=type%>" appid="<%=appid%>" imgsrc_val="<%=imgsrc_val%>"  imgsrc="<%=imgsrc%>" >'+
		'<div class="one-widget-navi">'+
			'<span><%=title%></span>'+
			'<div class="one-widget-option">'+
				'<div class="option-icon">'+
					'<a href="javascript:void(0)" class="option-icon-btn"><img src="<%=staticURL%>/portal/img/images/one-widget-option-img.png" /></a>'+
			...
			'</div>'+
		'</div>'+
		'<iframe id="<%=appid%>_dock_iframe" frameborder="0" src="<%=url%>" style="width: 100%; border: 0px none; height:<%=height%>px;max-height:<%=height%>"></iframe>'+
	'</div>'
);